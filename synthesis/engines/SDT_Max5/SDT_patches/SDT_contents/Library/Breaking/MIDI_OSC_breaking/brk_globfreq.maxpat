{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 66.0, 81.0, 581.0, 428.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 81.0, 581.0, 428.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BREAKING #1 Global Frequency Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 730.0, 168.0, 40.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 730.0, 150.0, 55.0, 17.0 ]
				}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Global frequency\" mapping Max patch must be saved in SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_globfreq.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Breaking N Global Frequency MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BREAKING #1 Global Frequency Control Mapping",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -10.0, 228.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll brk_globfreq_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 201.0, 184.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "brk_globfrequency_map.mxb",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-9",
					"numoutlets" : 1,
					...
					"patching_rect" : [ 422.0, 281.0, 146.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 34.0, 122.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "brk_globfrequency_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_globfreq/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 431.0, 249.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "brk_globfreq_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
					"name" : "brk_globfrequency_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 176.0, 431.5, 176.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 431.5, 330.0, 435.5, 330.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 739.5, 192.0, 606.5, 192.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 1,
					"midpoints" : [ 591.5, -12.0, 739.5, -12.0 ]
				}
