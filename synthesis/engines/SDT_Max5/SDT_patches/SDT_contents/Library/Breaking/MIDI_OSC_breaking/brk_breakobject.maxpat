{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 40.0, 218.0, 553.0, 430.0 ],
		"bglocked" : 0,
		"defrect" : [ 40.0, 218.0, 553.0, 430.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BREAKING #1 Break Object Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 187.0, 552.0, 466.0, 278.0 ],
						"bglocked" : 0,
						"defrect" : [ 187.0, 552.0, 466.0, 278.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Drop object\" mapping Max patch must be saved in SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_breakhit.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Breaking N Break Object MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BREAKING #1 Break Object Control Mapping",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -13.0, 209.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll brk_dropobject_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 35.0, 122.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "breakhit_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_breakhit/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 430.0, 251.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "brk_dropobject_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
