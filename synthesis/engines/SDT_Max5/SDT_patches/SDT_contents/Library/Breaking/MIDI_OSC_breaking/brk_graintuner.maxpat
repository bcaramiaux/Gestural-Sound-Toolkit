{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 66.0, 81.0, 563.0, 425.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 81.0, 563.0, 425.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BREAKING #1 Grain Tuner Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 727.0, 167.0, 40.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 727.0, 145.0, 55.0, 17.0 ]
				}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Grain tuner\" mapping Max patch must be saved in SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_graintuner.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Breaking N Grain Tuner MIDI control mapping",
									"fontname" : "Arial Black",
									"numinlets" : 1,
									"id" : "obj-8",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 12.0, 13.0, 365.0, 23.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BREAKING #1 Grain Tuner Control Mapping",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -10.0, 205.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll brk_graintun_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 428.0, 282.0, 113.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 38.0, 132.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "graintuner_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_graintuner/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 432.0, 254.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "brk_grtuner_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
					"name" : "graintuner_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 736.5, 193.0, 606.5, 193.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 437.5, 330.0, 435.5, 330.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 176.0, 437.5, 176.0 ]
				}
