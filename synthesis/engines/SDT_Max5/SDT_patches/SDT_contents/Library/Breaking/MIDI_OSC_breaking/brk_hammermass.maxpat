{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 66.0, 81.0, 580.0, 430.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 81.0, 580.0, 430.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BREAKING #1 Hammer Mass Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 62.0, 47.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 721.0, 176.0, 40.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 721.0, 158.0, 55.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BREAKING #1 Hammer Mass Control Mapping",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -10.0, 216.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll brk_mass_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 201.0, 160.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 423.0, 283.0, 142.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 38.0, 144.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "brk_hammermass_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Breaking/MIDI_OSC_breaking/brk_hammermass/",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 85.0, 76.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 431.0, 251.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "brk_Hmass_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
					"name" : "brk_hammermass_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 1,
					"midpoints" : [ 591.5, -12.0, 730.5, -12.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 730.5, 196.0, 606.5, 196.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 432.5, 330.0, 435.5, 330.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 176.0, 432.5, 176.0 ]
				}
