{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 555.0, 475.0, 270.0, 219.0 ],
		"bglocked" : 0,
		"defrect" : [ 555.0, 475.0, 270.0, 219.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "midi control CONTINUOUS CRUMPLING #1",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b #1",
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 49.0, -59.0, 33.0, 17.0 ],
					"id" : "obj-87",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s Ccrump_1midcontrol",
					"patching_rect" : [ 65.0, -41.0, 101.0, 17.0 ],
					"id" : "obj-85",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, -78.0, 83.0, 17.0 ],
					"id" : "obj-83",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "Impact stiffness",
					"linecount" : 2,
					"patching_rect" : [ 5.0, 41.0, 51.0, 27.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title midi control CONTINUOUS CRUMPLING #1",
					"linecount" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.0, -19.0, 139.0, 25.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "Impact shape",
					"linecount" : 2,
					"patching_rect" : [ 64.0, 41.0, 62.0, 27.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 							{
								"box" : 								{
									...
									"linecount" : 3,
									"color" : [ 0.6, 0.4, 0.6, 1.0 ],
									"patching_rect" : [ 347.0, 194.0, 58.0, 38.0 ],
									"id" : "obj-18",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Force",
					"patching_rect" : [ 131.0, 41.0, 51.0, 17.0 ],
					"id" : "obj-73",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Resistance",
					"patching_rect" : [ 190.0, 41.0, 53.0, 17.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
