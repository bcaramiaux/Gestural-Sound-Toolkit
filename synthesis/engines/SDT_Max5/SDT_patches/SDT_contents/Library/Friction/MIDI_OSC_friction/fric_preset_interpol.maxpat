{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 66.0, 81.0, 572.0, 427.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 81.0, 572.0, 427.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "FRICTION #1 Preset Interpolation Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Preset interpolation\" mapping Max patch must be saved in SDT_contents/Library/Impact/MIDI_OSC_friction/fric_preset_interpol.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Friction N Preset interpolation MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title FRICTION #1 Preset Interpolation Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -12.0, 129.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll fric_preinterpol_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-5",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 199.0, 208.0, 16.0 ],
					"coll_data" : 					{
						"count" : 4,
						"data" : [ 							{
								"key" : 0,
								"value" : [ "script", "delete", "preset_interpol_MIDI_map" ]
							}
, 							{
								"key" : 1,
								"value" : [ "script", "new", "preset_interpol_MIDI_map", "bpatcher", 10, 10, 410, 410, 0, 0, "presinterp_map2.mxb", 1 ]
							}
, 							{
								"key" : 2,
								"value" : [ "script", "hidden", "connect", "inlet_up", 0, "preset_interpol_MIDI_map", 0 ]
							}
, 							{
								"key" : 3,
								"value" : [ "script", "hidden", "connect", "preset_interpol_MIDI_map", 0, "outlet_bottom", 0 ]
							}
 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 282.0, 113.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf %sfric_preset_interpol/",
					"fontname" : "Arial",
					"numinlets" : 1,
					"id" : "obj-12",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 36.0, 157.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : [ "presinterp_map.maxpat", ",", "presinterp_map2.maxpat" ],
					"prefix" : "Macintosh",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 426.0, 253.0, 100.0, 27.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 435.5, 328.0, 435.5, 328.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 174.0, 435.5, 174.0 ]
				}
