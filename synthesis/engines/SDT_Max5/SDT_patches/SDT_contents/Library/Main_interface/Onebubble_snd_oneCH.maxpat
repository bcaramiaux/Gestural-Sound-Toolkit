{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 596.0, 445.0, 442.0, 375.0 ],
		"bglocked" : 0,
		"defrect" : [ 596.0, 445.0, 442.0, 375.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 22.0, 185.0, 47.0, 17.0 ],
					"outlettype" : [ "open" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 22.0, 205.0, 54.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-28",
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 259.0, 16.0, 16.0 ],
					"hidden" : 1,
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p #1Onebubble_panning",
					"numinlets" : 1,
					"id" : "obj-32",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 8.0, 223.0, 109.0, 17.0 ],
					"outlettype" : [ "signal", "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 37.0, 553.0, 209.0, 210.0 ],
						"bglocked" : 0,
						"defrect" : [ 37.0, 553.0, 209.0, 210.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Onebubble.R",
									"linecount" : 2,
									"numinlets" : 1,
									"id" : "obj-8",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 116.0, 172.0, 73.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Onebubble.L",
									"linecount" : 2,
									"numinlets" : 1,
									"id" : "obj-4",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 27.0, 172.0, 71.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 1,
									"midpoints" : [ 260.5, 302.0, 238.0, 302.0, 238.0, 167.0, 125.5, 167.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-4", 0 ],
									"hidden" : 1,
									"midpoints" : [ 178.5, 304.0, 10.0, 304.0, 10.0, 166.0, 36.5, 166.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-33",
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 261.0, 15.0, 15.0 ],
					"hidden" : 1,
					"comment" : "sound out #1"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 4.0, 70.0, 15.0 ],
					"ignoreclick" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 260.0, 111.0, 111.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
...
, 							{
								"box" : 								{
									...
									"fontname" : "Courier",
									"numoutlets" : 1,
									"patching_rect" : [ 19.0, 170.0, 171.0, 74.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 10.0
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbl_rstsndch",
					"numinlets" : 0,
					"id" : "obj-3",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 272.0, 88.0, 89.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bbl_rmvsndch",
					"numinlets" : 0,
					"id" : "obj-4",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 260.0, 69.0, 94.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 260.0, 132.0, 61.0, 17.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "send to_bbl_mixer_thisp",
					"numinlets" : 1,
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 163.0, 122.0, 17.0 ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-8",
					"numoutlets" : 1,
					"patching_rect" : [ 153.0, 37.0, 13.0, 13.0 ],
					"outlettype" : [ "bang" ],
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"numoutlets" : 2,
					"patching_rect" : [ 139.0, 55.0, 39.0, 32.0 ],
					"outlettype" : [ "", "" ],
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 178.0, 96.0, 32.5, 14.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 137.0, 96.0, 32.5, 14.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 152.0, 119.0, 87.0, 34.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 18.0, 70.0, 15.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "receive~ #1onebubble_sound",
					"numinlets" : 1,
					"id" : "obj-24",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 4.0, -25.0, 140.0, 17.0 ],
					"outlettype" : [ "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 1,
					"midpoints" : [ 14.5, 34.0, 160.0, 34.0 ]
				}
