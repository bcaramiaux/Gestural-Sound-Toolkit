{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 875.0, 214.0, 278.0, 147.0 ],
		"bglocked" : 0,
		"defrect" : [ 875.0, 214.0, 278.0, 147.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r bounce_1oscontrol",
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 148.0, 92.0, 17.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r bounce_1midcontrol",
					"outlettype" : [ "" ],
					"patching_rect" : [ -79.0, 150.0, 97.0, 17.0 ],
					"id" : "obj-60",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ -133.0, 199.0, 73.0, 17.0 ],
					"id" : "obj-58",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 1.0, 171.0, 82.0, 17.0 ],
					"id" : "obj-48",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "if $i1 >=1 then $i1",
					"outlettype" : [ "" ],
					"patching_rect" : [ -133.0, 171.0, 82.0, 17.0 ],
					"id" : "obj-49",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "Bouncing_soundout",
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 186.0, 107.0, 94.0, 17.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r bounce_removeme",
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, -35.0, 101.0, 17.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ -52.0, 93.0, 146.0, 25.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 56.0, 108.0, 15.0, 15.0 ],
					"id" : "obj-18",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 108.0, 89.0, 17.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "s bounce_closeall",
									"patching_rect" : [ 108.0, 96.0, 88.0, 17.0 ],
									"id" : "obj-3",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"outlettype" : [ "" ],
					"patching_rect" : [ -132.0, 244.0, 47.0, 17.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "i",
					"outlettype" : [ "int" ],
					"patching_rect" : [ -133.0, 150.0, 27.0, 17.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "load bouncing_midi_map $1",
					"linecount" : 2,
					"outlettype" : [ "" ],
					"patching_rect" : [ -133.0, 223.0, 102.0, 25.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "thispatcher",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -200.0, 227.0, 61.0, 17.0 ],
					"id" : "obj-33",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 88.0, 89.0, 17.0 ],
					"id" : "obj-40",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "panel",
					"bgcolor" : [ 0.894118, 0.278431, 0.278431, 1.0 ],
					"patching_rect" : [ 56.0, 106.0, 107.0, 18.0 ],
					"id" : "obj-46",
					"rounded" : 2,
					"numinlets" : 1,
					"shadow" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "panel",
					"bgcolor" : [ 0.894118, 0.278431, 0.278431, 1.0 ],
					"patching_rect" : [ 56.0, 87.0, 107.0, 18.0 ],
					"id" : "obj-45",
					"rounded" : 2,
					"numinlets" : 1,
					"shadow" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 270.5, 131.0, 272.0, 131.0, 272.0, 19.0, 216.5, 19.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 27.5, 132.0, -115.5, 132.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-28", 0 ],
					"hidden" : 1,
					"midpoints" : [ 10.5, 248.0, -122.5, 248.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 65.0, 132.0, -123.5, 132.0 ]
				}
