{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 16.0, 384.0, 278.0, 148.0 ],
		"bglocked" : 0,
		"defrect" : [ 16.0, 384.0, 278.0, 148.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r bbl_1oscontrol",
					"numinlets" : 0,
					"patching_rect" : [ 41.0, 148.0, 75.0, 17.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r bbl_1midcontrol",
					"numinlets" : 0,
					"patching_rect" : [ -102.0, 149.0, 80.0, 17.0 ],
					"id" : "obj-60",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ -130.0, 199.0, 73.0, 17.0 ],
					"id" : "obj-58",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "1midiosccontrol",
					"numinlets" : 2,
					"patching_rect" : [ 10.0, 200.0, 73.0, 17.0 ],
					"id" : "obj-57",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 10.0, 172.0, 82.0, 17.0 ],
					"id" : "obj-48",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "if $i1 >=1 then $i1",
					"numinlets" : 1,
					"patching_rect" : [ -130.0, 173.0, 82.0, 17.0 ],
					"id" : "obj-50",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 256.0, 29.0, 13.0, 58.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "onebubble_instance_recall",
					"numinlets" : 4,
					"patching_rect" : [ 45.0, 67.0, 128.0, 17.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "r bbl_removeme",
					"numinlets" : 0,
					"patching_rect" : [ 23.0, -35.0, 84.0, 17.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 2,
					"patching_rect" : [ -52.0, 85.0, 146.0, 25.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "Close Onebubble Model",
					"numinlets" : 2,
					"patching_rect" : [ 56.0, 125.0, 110.0, 15.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "i",
					"numinlets" : 2,
					"patching_rect" : [ 10.0, 149.0, 27.0, 17.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "load onebubble_OSC_map $1",
					"linecount" : 3,
					"numinlets" : 2,
					"patching_rect" : [ 10.0, 223.0, 66.0, 36.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "s bbl_closeall",
									"numinlets" : 1,
									"patching_rect" : [ 108.0, 96.0, 71.0, 17.0 ],
									"id" : "obj-3",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"fontsize" : 9.0
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "onebubble_soundout",
					"numinlets" : 1,
					"patching_rect" : [ 186.0, 109.0, 98.0, 17.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"numinlets" : 1,
					"patching_rect" : [ -130.0, 267.0, 47.0, 17.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "i",
					"numinlets" : 2,
					"patching_rect" : [ -130.0, 150.0, 27.0, 17.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "load onebubble_midi_map $1",
					"linecount" : 3,
					"numinlets" : 2,
					"patching_rect" : [ -130.0, 224.0, 67.0, 36.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "thispatcher",
					"numinlets" : 1,
					"patching_rect" : [ -196.0, 233.0, 61.0, 17.0 ],
					"id" : "obj-33",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "panel",
					"bgcolor" : [ 0.815686, 0.94902, 1.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.815686, 0.94902, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 57.0, 106.0, 100.0, 15.0 ],
					"id" : "obj-46",
					"rounded" : 2,
					"numoutlets" : 0,
					"shadow" : 1
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.815686, 0.94902, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 57.0, 87.0, 100.0, 15.0 ],
					"id" : "obj-45",
					"rounded" : 2,
					"numoutlets" : 0,
					"shadow" : 1
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 274.5, 132.0, 284.0, 132.0, 284.0, 21.0, 216.5, 21.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 195.5, 131.0, 284.0, 131.0, 284.0, 20.0, 239.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 3 ],
					"hidden" : 1,
					"midpoints" : [ 27.5, 84.0, 138.0, 84.0, 138.0, 58.0, 163.5, 58.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 1 ],
					"hidden" : 1,
					"midpoints" : [ 129.5, 84.0, 142.0, 84.0, 142.0, 58.0, 90.833336, 58.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 65.0, 132.0, 19.5, 132.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 27.5, 132.0, -112.5, 132.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 19.5, 270.0, -120.5, 270.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 65.0, 132.0, -120.5, 132.0 ]
				}
