{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 320.0, 425.0, 472.0, 403.0 ],
		"bglocked" : 0,
		"defrect" : [ 320.0, 425.0, 472.0, 403.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 19.0, 197.0, 47.0, 17.0 ],
					"outlettype" : [ "open" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 19.0, 217.0, 54.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-28",
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 271.0, 16.0, 16.0 ],
					"hidden" : 1,
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p #1friction_panning",
					"numinlets" : 1,
					"id" : "obj-27",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 5.0, 235.0, 92.0, 17.0 ],
					"outlettype" : [ "signal", "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 37.0, 553.0, 218.0, 210.0 ],
						"bglocked" : 0,
						"defrect" : [ 37.0, 553.0, 218.0, 210.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Friction.R",
									"numinlets" : 1,
									"id" : "obj-8",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 115.0, 173.0, 86.0, 17.0 ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Friction.L",
									"numinlets" : 1,
									"id" : "obj-4",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 173.0, 85.0, 17.0 ],
									"fontsize" : 9.0
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 1,
									"midpoints" : [ 260.5, 303.0, 233.0, 303.0, 233.0, 169.0, 124.5, 169.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-4", 0 ],
									"hidden" : 1,
									"midpoints" : [ 178.5, 302.0, 13.0, 302.0, 13.0, 169.0, 35.5, 169.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 119.0, 50.0, 15.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-30",
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 273.0, 15.0, 15.0 ],
					"hidden" : 1,
					"comment" : "sound out #1"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 4.0, 56.0, 15.0 ],
					"ignoreclick" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 159.0, 111.0, 111.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
...
, 							{
								"box" : 								{
									...
									"fontname" : "Courier",
									"numoutlets" : 1,
									"patching_rect" : [ 19.0, 170.0, 213.0, 54.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 10.0
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1fric_rstsndch",
					"numinlets" : 0,
					"id" : "obj-3",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 171.0, 88.0, 93.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1fric_rmvsndch",
					"numinlets" : 0,
					"id" : "obj-4",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 159.0, 69.0, 98.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 159.0, 132.0, 61.0, 17.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 71.0, -1.0, 72.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "send to_friction_mixer_thisp",
					"numinlets" : 1,
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 163.0, 143.0, 17.0 ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 94.0, 96.0, 32.5, 14.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 102.0, 20.0, 17.0 ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3.0, 103.0, 35.0, 17.0 ],
					"triangle" : 0,
