{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 621.0, 400.0, 397.0, 403.0 ],
		"bglocked" : 0,
		"defrect" : [ 621.0, 400.0, 397.0, 403.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p #1impact_panning",
					"numinlets" : 1,
					"id" : "obj-27",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 6.0, 233.0, 92.0, 17.0 ],
					"outlettype" : [ "signal", "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 38.0, 553.0, 205.0, 205.0 ],
						"bglocked" : 0,
						"defrect" : [ 38.0, 553.0, 205.0, 205.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 114.0, 168.0, 58.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 168.0, 61.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 1,
									"midpoints" : [ 260.5, 302.0, 246.0, 302.0, 246.0, 166.0, 123.5, 166.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-4", 0 ],
									"hidden" : 1,
									"midpoints" : [ 178.5, 302.0, 14.0, 302.0, 14.0, 167.0, 39.5, 167.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 119.0, 50.0, 15.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 144.0, 65.0, 111.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1imp_rstsndch",
					"numinlets" : 0,
					"id" : "obj-2",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 156.0, 42.0, 92.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1imp_rmvsndch",
					"numinlets" : 0,
					"id" : "obj-3",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 144.0, 23.0, 97.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 144.0, 86.0, 61.0, 17.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 83.0, 3.0, 72.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "send to_impact_mixer_thisp",
					"linecount" : 3,
					"numinlets" : 1,
					"id" : "obj-6",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 163.0, 61.0, 38.0 ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3.0, 102.0, 35.0, 17.0 ],
					"triangle" : 0,
