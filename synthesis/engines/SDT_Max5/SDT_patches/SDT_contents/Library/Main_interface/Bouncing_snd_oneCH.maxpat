{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 953.0, 278.0, 389.0, 446.0 ],
		"bglocked" : 0,
		"defrect" : [ 953.0, 278.0, 389.0, 446.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 20.0, 195.0, 47.0, 17.0 ],
					"outlettype" : [ "open" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 20.0, 215.0, 54.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-28",
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 269.0, 16.0, 16.0 ],
					"hidden" : 1,
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p #1Bouncing_panning",
					"numinlets" : 1,
					"id" : "obj-27",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 6.0, 233.0, 103.0, 17.0 ],
					"outlettype" : [ "signal", "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 37.0, 553.0, 210.0, 212.0 ],
						"bglocked" : 0,
						"defrect" : [ 37.0, 553.0, 210.0, 212.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Bouncing.R",
									"linecount" : 2,
									"numinlets" : 1,
									"id" : "obj-8",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 113.0, 167.0, 69.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "send~ #1Bouncing.L",
									"linecount" : 2,
									"numinlets" : 1,
									"id" : "obj-4",
									"fontname" : "Arial",
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 167.0, 64.0, 27.0 ],
									"fontsize" : 9.0
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 1,
									"midpoints" : [ 260.5, 304.0, 238.0, 304.0, 238.0, 160.0, 122.5, 160.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-4", 0 ],
									"hidden" : 1,
									"midpoints" : [ 178.5, 302.0, 13.0, 302.0, 13.0, 163.0, 38.5, 163.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 7.0, 119.0, 50.0, 15.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-30",
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 271.0, 15.0, 15.0 ],
					"hidden" : 1,
					"comment" : "sound out #1"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 108.0, 119.0, 87.0, 34.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 1.0, 4.0, 65.0, 15.0 ],
					"ignoreclick" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 203.0, 110.0, 111.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 840.0, 132.0, 600.0, 426.0 ],
						"bglocked" : 0,
						"defrect" : [ 840.0, 132.0, 600.0, 426.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"fontname" : "Courier",
									"numoutlets" : 1,
									"patching_rect" : [ 19.0, 170.0, 201.0, 64.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 10.0
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bounce_rstsndch",
					"numinlets" : 0,
					"id" : "obj-4",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 215.0, 87.0, 106.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r #1bounce_rmvsndch",
					"numinlets" : 0,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 203.0, 68.0, 111.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 203.0, 131.0, 61.0, 17.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 100.0, -1.0, 72.0, 17.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "send to_bounce_mixer_thisp",
					"numinlets" : 1,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 163.0, 139.0, 17.0 ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"numoutlets" : 1,
					"patching_rect" : [ 109.0, 37.0, 13.0, 13.0 ],
					"outlettype" : [ "bang" ],
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"numoutlets" : 2,
					"patching_rect" : [ 95.0, 55.0, 39.0, 32.0 ],
					"outlettype" : [ "", "" ],
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 120.0, 96.0, 32.5, 14.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Courier",
					"numoutlets" : 1,
					"patching_rect" : [ 93.0, 96.0, 32.5, 14.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"rounded" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 138.0, 68.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 1.0, 18.0, 65.0, 15.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1.0, 103.0, 35.0, 17.0 ],
					"triangle" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "receive~ #1bounce_sound",
					"numinlets" : 1,
					"id" : "obj-24",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 4.0, -25.0, 127.0, 17.0 ],
					"outlettype" : [ "signal" ],
					"fontsize" : 9.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"rounded" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 1.0, 68.0, 135.0 ],
					"bgcolor" : [ 0.890196, 0.870588, 1.0, 1.0 ],
					"border" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 10.5, 34.0, 116.0, 34.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 109.5, 21.0, 15.5, 21.0 ]
				}
