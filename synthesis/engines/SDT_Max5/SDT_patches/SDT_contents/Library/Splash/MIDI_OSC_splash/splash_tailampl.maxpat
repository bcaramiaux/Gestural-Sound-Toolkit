{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 327.0, 239.0, 565.0, 432.0 ],
		"bglocked" : 0,
		"defrect" : [ 327.0, 239.0, 565.0, 432.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 714.0, 50.0, 47.0, 17.0 ]
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Tail Ampl\" mapping Max patch must be saved in SDT_contents/Library/Splash/MIDI_OSC_splash/splash_tailampl.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-1",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Splash N Tail Ampl MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title SPLASH #1 Tail Ampl Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 430.0, -26.0, 116.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 598.0, 186.0, 154.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 714.0, 23.0, 134.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "splash_tailamp_map.maxpat",
					"prefix" : "Macintosh",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 425.0, 239.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "splash_tailampl_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-25",
					"numoutlets" : 1,
