{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 256.0, 416.0, 577.0, 427.0 ],
		"bglocked" : 0,
		"defrect" : [ 256.0, 416.0, 577.0, 427.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "IMPACT #1 Impact Stiffness Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 714.0, 40.0, 47.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 500.0, 389.0, 51.0, 17.0 ],
					"patcher" : 					{
						"fileversion" : 1,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Material elasticity\" mapping Max patch must be saved in SDT_contents/Library/Impact/MIDI_OSC_impact/imp_elasticity.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-1",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Impact N Material Elasticity MIDI control mapping",
									"fontname" : "Arial Black",
									"numinlets" : 1,
									"id" : "obj-6",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 8.0, 6.0, 343.0, 23.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title IMPACT #1 Impact Stiffness Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 430.0, -26.0, 113.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll imp_stiff_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-5",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.0, 269.0, 109.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 714.0, 23.0, 126.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : [ "Stiffness_map.maxpat", ",", "Stiffness_map2.maxpat", ",", "Stiffness_map3.maxpat" ],
					"prefix" : "Macintosh",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 426.0, 240.0, 100.0, 27.0 ]
				}
