{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 252.0, 167.0, 562.0, 429.0 ],
		"bglocked" : 0,
		"defrect" : [ 252.0, 167.0, 562.0, 429.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BOUNCING #1 Contact Surface Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 709.0, 172.0, 40.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 709.0, 151.0, 55.0, 17.0 ]
				}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Contact surface\" mapping Max patch must be saved in SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_contsurf.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Bouncing N Contact Surface MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BOUNCING #1 Contact Surface Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -14.0, 189.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll bnc_cont_surface_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 197.0, 208.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 280.0, 113.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 34.0, 123.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "contsurface_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_contsurf/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 429.0, 249.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "bnc_surface_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
					"name" : "contsurface_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 172.0, 435.5, 172.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 435.5, 326.0, 435.5, 326.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 718.5, 194.0, 606.5, 194.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 1,
					"midpoints" : [ 591.5, -16.0, 718.5, -16.0 ]
				}
