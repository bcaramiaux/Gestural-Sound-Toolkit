{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 83.0, 344.0, 560.0, 431.0 ],
		"bglocked" : 0,
		"defrect" : [ 83.0, 344.0, 560.0, 431.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BOUNCING #1 Shape Regularity Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 56.0, 47.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 716.0, 161.0, 40.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 716.0, 143.0, 55.0, 17.0 ]
				}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Shaper regularity\" mapping Max patch must be saved in SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_shapereg.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Bouncing N Shape Regularity MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BOUNCING #1 Shape Regularity Control Mapping",
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -12.0, 228.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll bnc_shape_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 199.0, 166.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 422.0, 284.0, 113.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 36.0, 125.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "shapereg_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_shapereg/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 425.0, 253.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "bnc_shape_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-27",
					"numoutlets" : 1,
					"name" : "shapereg_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 1,
					"midpoints" : [ 591.5, -13.0, 725.5, -13.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 725.5, 194.0, 606.5, 194.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 431.5, 328.0, 435.5, 328.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 174.0, 431.5, 174.0 ]
				}
