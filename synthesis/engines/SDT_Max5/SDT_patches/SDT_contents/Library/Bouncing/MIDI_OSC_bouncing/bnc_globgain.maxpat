{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 66.0, 81.0, 568.0, 430.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 81.0, 568.0, 430.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BOUNCING #1 Global Gain Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Global gain\" mapping Max patch must be saved in SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_globgain.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-3",
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Bouncing N Global Gain MIDI control mapping",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BOUNCING #1 Global Gain Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-4",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 415.0, -12.0, 141.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll bnc_globgain_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.0, 286.0, 113.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Bouncing/MIDI_OSC_bouncing/bnc_globgain/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 431.0, 257.0, 100.0, 27.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 436.5, 328.0, 435.5, 328.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 542.5, 174.0, 436.5, 174.0 ]
				}
