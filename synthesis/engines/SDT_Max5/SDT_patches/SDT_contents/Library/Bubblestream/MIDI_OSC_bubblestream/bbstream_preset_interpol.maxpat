{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 104.0, 60.0, 576.0, 430.0 ],
		"bglocked" : 0,
		"defrect" : [ 104.0, 60.0, 576.0, 430.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BUBBLESTREAM #1 Preset Interpolation Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Preset interpolation\" mapping Max patch must be saved in SDT_contents/Library/Bubblestream/MIDI_OSC_bubblestream/bbstream_preset_interpol.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-1",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 136.0, 171.0, 55.0, 13.0 ]
								}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Bubblestream N Preset interpolation MIDI control mapping",
									"fontname" : "Arial Black",
									"numinlets" : 1,
									"id" : "obj-7",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 12.0, 6.0, 400.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"bgcolor" : [ 0.67451, 0.945098, 0.611765, 1.0 ],
									"patching_rect" : [ 13.0, 103.0, 408.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"bgcolor" : [ 0.67451, 0.945098, 0.611765, 1.0 ],
									"patching_rect" : [ 188.0, 183.0, 96.0, 13.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"fontsize" : 10.0,
									"patching_rect" : [ 13.0, 170.0, 370.0, 52.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BUBBLESTREAM #1 Preset Interpolation Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 409.0, -17.0, 196.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll bbstream_presinterp_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-5",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 597.0, 195.0, 202.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 251.0, 139.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf %sbbstream_preset_interpol/",
					"fontname" : "Arial",
					"numinlets" : 1,
					"id" : "obj-12",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 32.0, 182.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Bubblestream/MIDI_OSC_bubblestream/bbstream_preset_interpol/",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 713.0, 83.0, 76.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 435.0, 221.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "presinterp_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-25",
					"numoutlets" : 1,
					"name" : "pres_interpol_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
