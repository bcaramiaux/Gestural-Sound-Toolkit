{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 321.0, 349.0, 550.0, 429.0 ],
		"bglocked" : 0,
		"defrect" : [ 321.0, 349.0, 550.0, 429.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "BUBBLESTREAM #1 Envelope Smoothness Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 167.0, 342.0, 443.0, 197.0 ],
						"bglocked" : 0,
						"defrect" : [ 167.0, 342.0, 443.0, 197.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"Global frequency\" mapping Max patch must be saved in SDT_contents/Library/Bubblestream/MIDI_OSC_bubblestream/bbstream_envelope.",
									"linecount" : 3,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-1",
									"numoutlets" : 0,
									"fontsize" : 10.0,
									"patching_rect" : [ 4.0, 71.0, 423.0, 41.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"fontsize" : 10.0,
									"patching_rect" : [ 4.0, 36.0, 415.0, 29.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"fontsize" : 10.0,
									"patching_rect" : [ 4.0, 119.0, 409.0, 29.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 4.0, 36.0, 119.0, 13.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"bgcolor" : [ 0.752941, 0.717647, 0.960784, 1.0 ],
									"patching_rect" : [ 4.0, 119.0, 133.0, 13.0 ]
								}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Bubblestream N Envelope Smoothness MIDI control mapping",
									"fontname" : "Arial Black",
									"numinlets" : 1,
									"id" : "obj-6",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 3.0, 1.0, 409.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 4.0, 98.0, 422.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"bgcolor" : [ 0.752941, 0.717647, 0.960784, 1.0 ],
									"patching_rect" : [ 4.0, 71.0, 162.0, 13.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title BUBBLESTREAM #1 Envelope Smoothness Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 396.0, -26.0, 175.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll bbstream_envelope_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-5",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 595.0, 186.0, 190.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 423.0, 259.0, 99.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf %sbbstream_envelope/",
					"fontname" : "Arial",
					"numinlets" : 1,
					"id" : "obj-12",
					"numoutlets" : 1,
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 711.0, 23.0, 151.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "envelope_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Bubblestream/MIDI_OSC_bubblestream/bbstream_envelope/",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 425.0, 230.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "envelope_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-25",
					"numoutlets" : 1,
					"name" : "envelope_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 432.5, 315.0, 433.5, 315.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 540.5, 161.0, 432.5, 161.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 1,
					"midpoints" : [ 589.5, -28.0, 405.5, -28.0 ]
				}
