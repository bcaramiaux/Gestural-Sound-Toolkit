{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 104.0, 60.0, 567.0, 433.0 ],
		"bglocked" : 0,
		"defrect" : [ 104.0, 60.0, 567.0, 433.0 ],
		...
		"enablevscroll" : 1,
		"devicewidth" : 0.0,
		"title" : "CRUMPLING #1 Impact Stiffness Control Mapping",
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "tosymbol",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 716.0, 62.0, 47.0, 17.0 ]
				}
				...
				"box" : 				{
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "2) DISPLAY BOX (purple color): click on the box to load and edit the correspondent control mapping patch. \"impact stiffness\" mapping Max patch must be saved in SDT_contents/Library/Crumpling/MIDI_OSC_crumpling/crump_brist_stiff.",
									"linecount" : 4,
									"fontname" : "Arial",
									"numinlets" : 1,
									"id" : "obj-1",
									"numoutlets" : 0,
									"fontsize" : 10.0,
									"patching_rect" : [ 9.0, 79.0, 375.0, 52.0 ]
								}
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "Crumpling N Impact Stiffness MIDI control mapping",
									"fontname" : "Arial Black",
									"numinlets" : 1,
									"id" : "obj-7",
									"numoutlets" : 0,
									"fontsize" : 12.0,
									"patching_rect" : [ 8.0, 9.0, 365.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.0, 119.0, 390.0, 13.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "title CRUMPLING #1 Impact Stiffness Control Mapping",
					"linecount" : 2,
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2",
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 432.0, -15.0, 126.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "coll crump_impstiff_map_replace",
					"fontname" : "Courier",
					"numinlets" : 1,
					"id" : "obj-5",
					"numoutlets" : 4,
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 600.0, 196.0, 196.0, 16.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 425.0, 242.0, 104.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 716.0, 33.0, 140.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : "crump_stiff_map.maxpat",
					"prefix" : "Macintosh HD:/Users/sdellemo/Documents/01_SoundDesignToolKit/SDT_contents/Library/Crumpling/MIDI_OSC_crumpling/crump_imp_stiff/",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"hidden" : 1,
					"patching_rect" : [ 716.0, 78.0, 76.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 427.0, 212.0, 100.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "crump_impstiff_MIDI_map",
					"numinlets" : 1,
					"id" : "obj-25",
					"numoutlets" : 1,
					"name" : "crump_stiff_map.maxpat",
					"args" : [  ],
					"outlettype" : [ "float" ],
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-16", 0 ],
					"hidden" : 1,
					"midpoints" : [ 725.5, 106.0, 436.5, 106.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 1,
					"midpoints" : [ 545.5, 171.0, 434.5, 171.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 434.5, 325.0, 438.5, 325.0 ]
				}
