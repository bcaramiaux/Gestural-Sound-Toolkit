...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 751.397430419921875, 314.867477891601538, 200.0, 22.0 ],
					"text" : "switch 3"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-16",
					"items" : [ "off", ",", "slider", ",", "recording", ",", "prediction" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.397430419921875, 262.819153306640601, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 710.048324584960938, 150.0, 74.0 ],
					"text" : "Steps:\n\n1. Turn on audio\n2. Drop a sound folder\n3. "
				}
...
,
					"patching_rect" : [ 211.30572509765625, 77.542694999999981, 68.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 366.30572509765625, 317.319122314453125, 92.931620279947936, 22.0 ],
					"text" : "t 1 i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 366.30572509765625, 287.4757080078125, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 366.30572509765625, 347.084000108398413, 240.79486083984375, 145.891738891601562 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 640.0, 512.975738999999976, 182.97576904296875, 110.099037170410156 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 811.730763753255246, 49.0, 206.0, 28.0 ],
					"size" : 5.0
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -4.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 211.30572509765625, 109.90875244140625, 512.79486083984375, 141.56695556640625 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 640.0, 347.084000108398413, 241.79486083984375, 145.891738891601562 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 165.1566162109375, 133.731216430664062, 116.319091796875 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -6.0, 0.0 ],
					"outlettype" : [ "", "", "", "float" ],
					"patching_rect" : [ 18.0, 13.975739000000001, 163.0, 132.566956000000005 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 18.0, 311.975738999999976, 302.0, 181.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-15::obj-18::obj-88" : [ "live.toggle", "live.toggle", 0 ],
			"obj-15::obj-18::obj-92" : [ "live.toggle[2]", "live.toggle", 0 ],
			"parameterbanks" : 			{
