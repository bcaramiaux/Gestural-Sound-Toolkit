...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 57.0, 105.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 142.0, 112.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 130.0, 79.0, 18.0 ],
					"presentation_rect" : [ 53.0, 114.0, 0.0, 0.0 ],
					"text" : "play $1 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 47.0, 224.0, 22.0 ],
					"text" : "MuBu tracks player (experimental)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 179.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 75.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 246.0, 66.0, 18.0 ],
					"text" : "trackid 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 96.0, 212.0, 28.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 312.0, 80.0, 18.0 ],
					"text" : "bufferindex 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 279.0, 86.0, 18.0 ],
					"text" : "bufferindex $1"
				}
...
,
					"patching_rect" : [ 30.0, 440.0, 77.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 116.25, 440.0, 59.416664, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 202.5, 440.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 288.75, 440.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 75.0, 91.0, 20.0 ],
					"text" : "prepend cursor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 375.0, 475.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 489.0, 51.0, 20.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.25, 278.0, 28.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 375.0, 440.0, 61.0, 20.0 ],
					"text" : "route end"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 213.0, 63.0, 18.0 ],
					"text" : "trackid $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 88.0, 49.0, 18.0 ],
					"text" : "play $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 392.0, 364.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"toolbar_size" : 30,
					"toolbar_visible" : 1,
					"viewconfig" : [ "interface score, bounds 36 59, autobounds 1", "interface score, bounds 60 71, autobounds 1" ],
					"windresize" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 28.0, 718.0, 503.0 ],
					"rounded" : 24,
					"varname" : "HelpFrame"
				}
