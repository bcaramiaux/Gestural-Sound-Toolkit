...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 404.0, 617.0, 99.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 125.0, 392.0, 222.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 41.0, 7.0, 232.0, 34.0 ],
...
,
					"patching_rect" : [ 556.0, 171.5, 141.0, 23.0 ],
...
,
					"patching_rect" : [ 573.0, 115.5, 124.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"tags" : "",
						"digest" : "",
...
,
					"patching_rect" : [ 560.0, 143.5, 137.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"tags" : "",
						"digest" : "",
...
,
					"patching_rect" : [ 548.0, 87.5, 149.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"tags" : "",
						"digest" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 853.0, 334.5, 286.0, 103.0 ],
...
,
					"patching_rect" : [ 581.0, 59.5, 116.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"tags" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.754395, 12.0, 234.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 338.754395, 21.0, 133.420441, 13.798828 ],
					"presentation_rect" : [ 60.0, 60.0, 133.420441, 13.798828 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 211.0, 213.0, 48.0 ],
...
, 			{
				"box" : 				{
					"alignviewbounds" : 0,
					"audiobuffergui_config" : "interface multiwave, bgcolor 255 255 255 1, fgcolor 0 0 0 1, shape lines, bounds -0.339141846 0.43572998, thickness 1, visible 1, layout juxtaposed, opacity 1, foremost 0, colormode fgcolor, showcolnames 0, visibleindices 0, showmean 1, autobounds 0, fontsize 10, fontstyle 0, hidenotforemost 0",
					"autoupdate" : 120.0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bufferchooser_bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"bufferchooser_fgcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					...
					"toolbar_size" : 30,
					"toolbar_visible" : 2,
					"viewconfig" : [ "interface multibpf, bgcolor 255 255 255 1,fgcolor 0 0 0 0.250980407, shape bpf, bounds -0.132881001 1782, thickness 1, visible 1, layout juxtaposed, opacity 1, foremost 0, colormode fgcolor, showcolnames 0, visibleindices 0 1 2 3, autobounds 0, fontsize 10, fontstyle 0, hidenotforemost 0" ],
					"windresize" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 80.0, 212.0, 338.0, 48.0 ],
					"text" : "mubu.granular~ 2 granular-help @play 1 @positionvar 3 @duplicatechannels 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 44.0, 495.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 2.0, 284.0, 48.0 ],
					"text" : "mubu.granular~"
				}
