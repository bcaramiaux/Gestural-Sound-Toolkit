{
	"patcher" : 	{
		...
		"bglocked" : 1,
		"defrect" : [ 169.0, 44.0, 886.0, 681.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.754395, 15.0, 206.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 232.754395, 24.0, 133.367188, 13.798828 ],
					"presentation_rect" : [ 15.0, 15.0, 133.367188, 13.798828 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 127.0, 154.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 130.0, 158.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 139.0, 164.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 81.0, 44.0, 1074.0, 430.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 711.0, 585.0, 131.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 70.0, 794.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 43.0, 423.0, 234.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.0, 343.0, 285.0, 32.0 ],
...
, 			{
				"box" : 				{
					"alignviewbounds" : 0,
					"audiobuffergui_config" : "interface multiwave, bgcolor 255 255 255 1, fgcolor 0 0 0 1, shape lines, bounds -1 1, thickness 1, visible 1, layout juxtaposed, opacity 1, foremost 0, colormode fgcolor, showcolnames 0, visibleindices 0 1, showmean 1, autobounds 0, fontsize 10, fontstyle 0, hidenotforemost 0",
					"autoupdate" : 120.0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					...
					"toolbar_size" : 30,
					"toolbar_visible" : 0,
					"viewconfig" : [ "interface sonogram, bgcolor 255 255 255 1, fgcolor 0 0 0 1, colormode rainbow, bounds 0 24, depth 0 0.100000001, visible 1, autobounds 0, opacity 1, hidenotforemost 0" ],
					"windresize" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 45.0, 371.0, 23.0 ],
					"text" : "K-NN unit selection based on a KD-tree search algorithm"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 3.0, 186.0, 48.0 ],
					"text" : "mubu.knn"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-38", 0 ],
					"hidden" : 0,
					"midpoints" : [ 160.0, 486.5, 78.5, 486.5 ],
					"source" : [ "obj-23", 1 ]
				}
