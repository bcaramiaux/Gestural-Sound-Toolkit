...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 207.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 207.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 238.0, 122.0, 22.0 ],
					"text" : "pak 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 271.0, 100.0, 22.0 ],
					"text" : "setminmax $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 21.5, 201.0, 29.5, 22.0 ],
					"text" : "/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 21.5, 236.0, 31.0, 22.0 ],
					"text" : "sqrt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 133.5, 128.0, 39.0, 22.0 ],
					"text" : "zl len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.5, 89.5, 131.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.5, 276.0, 91.0, 20.0 ],
					"text" : "s #0-distance"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 84.0, 59.0, 105.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 4.0, 57.0, 45.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 4.0, 79.0, 45.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 84.0, 80.0, 105.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.5, 116.0, 77.0, 34.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 154.0, 284.0, 100.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 93.5, 75.0, 135.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 84.0, 31.0, 131.0, 20.0 ],
									"text" : "norm"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.5, 11.0, 68.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 3.0, 68.0, 20.0 ],
					"text" : "Norm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.5, 128.0, 88.0, 22.0 ],
					"text" : "vexpr $f1 * $f1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.5, 161.0, 45.0, 22.0 ],
					"text" : "zl sum"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 143.0, 190.0, 41.5, 190.0 ],
					"source" : [ "obj-5", 0 ]
				}
