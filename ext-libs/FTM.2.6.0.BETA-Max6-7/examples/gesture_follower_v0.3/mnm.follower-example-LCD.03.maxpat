{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 457.0, 227.0, 1223.0, 806.0 ],
		"bglocked" : 0,
		"defrect" : [ 457.0, 227.0, 1223.0, 806.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 23.0, 383.0, 27.0 ],
					"text" : "Example 3 : using drawing with the LCD object",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 51.0, 201.0, 34.0 ],
					"text" : "Example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 3.0, 90.0, 17.0 ],
					"text" : "MnM object set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 3.0, 52.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 17.0, 201.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 964.0, 371.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 950.0, 389.0, 58.0, 17.0 ],
					"text" : "change 0 +"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1035.0, 391.0, 134.0, 84.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1035.0, 369.0, 79.0, 17.0 ],
					"text" : "r 1_Enveloppes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 974.0, 420.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 950.0, 420.0, 20.0, 17.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 950.0, 473.0, 33.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 950.0, 445.0, 37.0, 17.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 350.0, 68.0, 17.0 ],
					"text" : "r 1_Markers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 624.0, 131.0, 17.0 ],
					"text" : "normalize between 0.and 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 711.0, 71.0, 17.0 ],
					"text" : "mnm.list2row"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 483.0, 56.0, 17.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 11.0, 523.0, 50.0, 17.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.0, 503.0, 50.0, 17.0 ],
					"text" : "metro 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 191.0, 81.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 472.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 494.0, 50.0, 17.0 ],
					"text" : "s 1_Start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 565.0, 71.0, 17.0 ],
					"presentation_rect" : [ 11.0, 565.0, 71.0, 17.0 ],
					"text" : [ "_($1 div 256.)" ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 489.0, 131.0, 623.0, 568.0 ],
						"bglocked" : 0,
						"defrect" : [ 489.0, 131.0, 623.0, 568.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 157.0, 134.0, 58.0, 17.0 ],
									"text" : "sel Update"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.0, 113.0, 108.0, 17.0 ],
									"text" : "r 1_FollowerDatabase"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 157.0, 154.0, 50.0, 17.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 124.0, 218.0, 83.0, 17.0 ],
									"text" : "mnm.winfilter 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 189.0, 284.0, 83.0, 17.0 ],
									"text" : "mnm.winfilter 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 238.0, 382.0, 29.0, 17.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 269.0, 406.0, 80.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 479.0, 40.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 479.0, 148.0, 35.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 238.0, 404.0, 27.0, 17.0 ],
									"text" : "> 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 238.0, 344.0, 83.493164, 17.0 ],
									"presentation_rect" : [ 238.0, 344.0, 83.493164, 17.0 ],
									"text" : [ "_(($1 sqrabs)sum)" ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 238.0, 323.0, 73.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 238.0, 362.0, 44.0, 17.0 ],
									"saved_object_attributes" : 									{
										"ftm_scope" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 77.0, 506.0, 70.0, 17.0 ],
									"text" : "filtered data"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 169.0, 507.0, 97.0, 17.0 ],
									"text" : "1st derivate of data"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 124.0, 242.0, 75.0, 17.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 189.0, 304.0, 59.0, 17.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.0, 429.0, 29.0, 17.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 189.0, 264.0, 90.0, 17.0 ],
									"text" : "mnm.derivate 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.0, 175.0, 32.0, 15.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 170.0, 486.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 105.0, 483.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 296.0, 366.0, 160.0, 27.0 ],
									"text" : "stop data flow if data variation is lower than a given threshold"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 247.5, 425.0, 114.5, 425.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 133.5, 297.0, 124.5, 297.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 247.5, 425.0, 179.5, 425.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
,
					"patching_rect" : [ 11.0, 586.0, 89.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 191.0, 31.0, 17.0 ],
					"text" : "r lcd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 544.0, 73.0, 17.0 ],
					"text" : "mnm.list2row"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 10.0, 170.0, 128.0, 17.0 ],
					"text" : "sel StartLearn StartDecode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 170.0, 74.0, 17.0 ],
					"text" : "r 1_WhatToDo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 191.0, 35.0, 15.0 ],
					"text" : "clear"
				}
...
,
					"patching_rect" : [ 157.0, 191.0, 73.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 213.0, 256.0, 256.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 588.0, 153.0, 17.0 ],
					"text" : "using velocities in this example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 469.0, 126.0, 23.0 ],
					"text" : "use the LCD or...",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 698.0, 156.0, 17.0 ],
					"text" : "normalized between 0 and 1",
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 610.0, 117.0, 643.0, 551.0 ],
						"bglocked" : 0,
						"defrect" : [ 610.0, 117.0, 643.0, 551.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.0, 27.0, 443.0, 20.0 ],
									"text" : "The patch requires FTM (http://ftm.ircam.fr/index.php/Download)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.0, 452.0, 364.0, 20.0 ],
									"text" : "more on http://ftm.ircam.fr/index.php/Gesture_Follower"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 421.0, 421.0, 27.0 ],
									"text" : "remarks:  - the section number allows you to record a different set of gestures (and recall them). This works like a \"preset\" (the decoding between sections are totally independent)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.0, 365.0, 421.0, 27.0 ],
									"text" : "3. the display \"real time warping\" directly shows the results of the time-warping of the gesture to the likeliest gesture"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.0, 328.0, 421.0, 27.0 ],
									"text" : "2. the display \"index\" shows \"where you are in the gesture\", like a (vertical) progress bar. (try first using only one gesture)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.0, 298.0, 282.0, 17.0 ],
									"text" : "The highest bar corresponds thus to the likeliest gesture"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.0, 271.0, 423.0, 27.0 ],
									"text" : "1. The display \"likelihood\" shows values indicating how close the performed gesture is to each recorded reference gesture"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.0, 255.0, 421.0, 17.0 ],
									"text" : "2. Start...Stop"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.0, 239.0, 421.0, 17.0 ],
									"text" : "1. the red button should be off"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 189.0, 226.0, 20.0 ],
									"text" : "2) to recognize/follow gesture"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 164.0, 421.0, 17.0 ],
									"text" : "3. change the \"phrase number\" and repeat this step with another gesture."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.0, 121.0, 176.0, 38.0 ],
									"text" : "Attention: in the example using the LCD, the start/stop is automated with mouse up/down from the LCD !"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 39.0, 104.0, 421.0, 17.0 ],
									"text" : "2. press start, play the gesture and stop."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 13.0, 53.0, 226.0, 20.0 ],
									"text" : "1) record a gesture "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 39.0, 88.0, 421.0, 17.0 ],
									"text" : "1- press the red button (learn). This arms the recording (it doesn't record anything yet)"
								}
...
,
					"patching_rect" : [ 992.0, 678.0, 84.0, 34.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 678.0, 156.0, 23.0 ],
					"text" : "HERE",
					"textcolor" : [ 0.909804, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 658.0, 156.0, 23.0 ],
					"text" : "input list (any length)",
					"textcolor" : [ 0.972549, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "mnm.follower.graphs4.03.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"offset" : [ -69.0, -73.0 ],
					"patching_rect" : [ 296.0, 507.0, 642.0, 202.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "mnm.follower.markers.03.maxpat",
					"numinlets" : 2,
					"numoutlets" : 3,
					"offset" : [ -30.0, -81.0 ],
					"outlettype" : [ "", "float", "float" ],
					"patching_rect" : [ 297.0, 346.0, 641.0, 161.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 736.0, 50.0, 17.0 ],
					"presentation_rect" : [ 201.0, 736.0, 50.0, 17.0 ],
					"text" : [ "_$init" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 141.0, 735.0, 49.119629, 17.0 ],
					"persistence" : 1,
					"presentation_rect" : [ 141.0, 735.0, 49.119629, 17.0 ],
					"scope" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 670.0, 31.0, 17.0 ],
					"text" : "s lcd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 607.0, 97.0, 17.0 ],
					"presentation_rect" : [ 90.0, 607.0, 97.0, 17.0 ],
					"text" : [ "_(($1 add 1.) div 2.)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 650.0, 47.0, 17.0 ],
					"saved_object_attributes" : 					{
						"ftm_scope" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 628.0, 73.0, 17.0 ],
					"presentation_rect" : [ 11.0, 628.0, 73.0, 17.0 ],
					"text" : [ "_($1 mul 256.)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 606.0, 74.0, 17.0 ],
					"saved_object_attributes" : 					{
						"ftm_scope" : 2
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 757.0, 121.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "mnm.follower.monitor.03.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ -38.0, -75.0 ],
					"patching_rect" : [ 618.0, 187.0, 320.0, 160.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "mnm.follower.gui.03.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 0.0, -48.0 ],
					"patching_rect" : [ 297.0, 186.0, 321.0, 160.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 172.0, 348.0, 17.0 ],
					"text" : "Frederic Bevilacqua and collaborators, Real Time Musical Interactions Team"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 172.0, 109.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 754.0, 172.0, 110.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 128.0, 88.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 100.0, 189.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 86.0, 109.0, 17.0 ],
					"text" : "Gesture Follower v0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 128.0, 102.0, 17.0 ],
					"text" : "http://ftm.ircam.fr/"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 114.0, 189.0, 17.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 19.5, 207.0, 19.5, 207.0 ],
					"source" : [ "obj-24", 0 ]
				}
