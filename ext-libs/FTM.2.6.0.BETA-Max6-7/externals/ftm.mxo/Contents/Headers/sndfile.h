...
{	SFC_GET_LIB_VERSION				= 0x1000,
	...
	SFC_GET_CUE_SIZE				= 0x10E8,
	SFC_GET_CUE_INFO				= 0x10E9,
...
/* Struct describing one cue/marker */
typedef struct
{
    int markerID;	/* id, need not be consecutive */
    int position;	/* position in sample frames */
...
typedef struct
{
    int	   num;		/* number of cues/markers */
    SF_CUE cue[0];	/* num allocated structs */
} SF_CUE_INFO ;
