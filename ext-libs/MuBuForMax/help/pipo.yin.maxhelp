...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 938.745605, 350.0, 256.0, 22.0 ],
					"style" : "",
					"text" : "unpack 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 938.745605, 279.0, 256.0, 49.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outputselection" : 0,
					"outputvalues" : 0,
					"patching_rect" : [ 28.0, 132.0, 852.508789, 361.0 ],
					"rangeruler_grid" : 0,
					"rangeruler_size" : 35,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 79.0, 673.0, 20.0 ],
					"style" : "",
					"text" : "Ref: Alain de Cheveigne and Hideki Kawahara, YIN: a fundamental frequency estimator for speech and musica, JASA 2002."
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "PiPo implementation of the YIN algorithm for monophonic pitch estimation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 8.0, 148.0, 47.0 ],
					"style" : "",
					"text" : "pipo.yin",
					"varname" : "HelpTitle"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.5, 610.5, 382.920441, 24.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "int", "" ],
					"patching_rect" : [ 520.5, 569.0, 704.0, 33.0 ],
					"style" : "",
					"text" : "mubu.process yin-help audio slice:yin @name yin @slice.wind none @slice.size 1710 @slice.hop 100 @yin.minfreq 50 @yin.downsampling 4 @process 1 @progressoutput input @info gui \"interface multiwave, thickness 3, colormode rainbow\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 29.0, 1251.0, 618.0 ],
					"proportion" : 0.39,
					"rounded" : 24,
					"style" : "",
					"varname" : "HelpFrame"
