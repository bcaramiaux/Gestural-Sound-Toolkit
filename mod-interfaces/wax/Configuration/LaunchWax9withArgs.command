...
echo "Enter ACC and GYR transmission rate [100, 200, 400, 800] "
read rate
...
echo "Enter MAG range [5, 10,20 40 80] "
read magrate
echo "Gyro range is $magrate "
echo
echo
# echo "rate is $1"
# echo "g is $2"
